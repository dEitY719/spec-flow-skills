# TRD: Skill Inventory — spec-flow-skills 문서 사이트

> **상태**: Draft v1 (2026-09-01)
> **책임 PRD 항목**: F-1, D-6, NF-6 ([PRD](../prd-docs-pages.md))
> **인용 NF**: NF-5
> **소유자**: @<github-handle-placeholder>
> **인접 TRD**: guide-pages, usage-pages, link-validation, ci-gate

## 1. Overview
> 1–2 문장. Skill Inventory 가 무엇이고 책임 PRD 항목을 어떻게 충족하는지.
