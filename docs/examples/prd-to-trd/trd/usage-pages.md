# TRD: Usage Pages — spec-flow-skills 문서 사이트

> **상태**: Draft v1 (2026-09-01)
> **책임 PRD 항목**: F-3, F-4, D-1, D-4, D-5 ([PRD](../prd-docs-pages.md))
> **인용 NF**: NF-3, NF-6
> **소유자**: @<github-handle-placeholder>
> **인접 TRD**: skill-inventory, html-rendering

## 1. Overview
> 1–2 문장. Usage Pages 가 무엇이고 책임 PRD 항목을 어떻게 충족하는지.
